...
def generate_launch_description():
    ...
    return LaunchDescription(
        [
            ...
            DeclareLaunchArgument("spawn_x",     default_value="-3.576731"),
            DeclareLaunchArgument("spawn_y",     default_value="-4.999903"),
            DeclareLaunchArgument("spawn_z",     default_value="0.03"),
            DeclareLaunchArgument("spawn_roll",  default_value="0.00"),
            DeclareLaunchArgument("spawn_pitch", default_value="0.000002"),
            DeclareLaunchArgument("spawn_yaw",   default_value="-0.053484"),
