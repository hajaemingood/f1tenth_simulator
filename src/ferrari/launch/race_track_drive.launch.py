...
def generate_launch_description():
    ...
    return LaunchDescription(
        [
            ...
            DeclareLaunchArgument("spawn_x",     default_value="2.462316"),
            DeclareLaunchArgument("spawn_y",     default_value="-2.132038"),
            ...
            DeclareLaunchArgument("spawn_yaw",   default_value="0.130703"),
