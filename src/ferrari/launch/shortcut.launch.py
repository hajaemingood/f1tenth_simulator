...
def generate_launch_description():
    ...
    return LaunchDescription(
        [
            ...
            DeclareLaunchArgument("spawn_x",     default_value="-3.848676"),
            DeclareLaunchArgument("spawn_y",     default_value="-0.156864"),
            ...
            DeclareLaunchArgument("spawn_yaw",   default_value="1.665843"),
